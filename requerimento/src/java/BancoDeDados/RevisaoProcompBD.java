...
import model.RevisaoProcomp;

/**
 *
 * @author Carlos
 */
public class RevisaoProcompBD {
    private Connection conexao;
    private List<RevisaoProcomp> listaProcomp;
    public RevisaoProcompBD() throws ClassNotFoundException{
    ...
    public List<RevisaoProcomp> getLista() throws ClassNotFoundException {
        try {
            ...
            while (rs.next()) {
                ...
                RevisaoProcomp revisao = new  RevisaoProcomp();
