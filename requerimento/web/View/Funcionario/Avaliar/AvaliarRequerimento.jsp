    ...
    <body>
        <center>
            ...
            <%String nome = request.getParameter("user");%>
                ...
                <a href="AvaliarProvaSubstitutiva.jsp">Avaliar Prova Substitutiva</a>
            <br>
            <br>
                <img src="../../../Imagem/icon.png" width="35" height="35" />
                <a href="AvaliarRevisaoProva.jsp">Avaliar Revisão de Prova</a>
            <br>
            <br>
                <img src="../../../Imagem/icon.png" width="35" height="35" />
                <a href="AvaliarRevisaoProcomp.jsp">Avaliar Revisão de PROCOMP</a>
            <br>
            <br>
                <img src="../../../Imagem/icon.png" width="35" height="35" />
                <a href="AvaliarRevisaoTgi.jsp">Avaliar Mudanças de Dados de TGI</a>
           <br>
           <br>
                <img src="../../../Imagem/icon.png" width="35" height="35" />
                <a href="AvaliarInscricoesFCI.jsp">Avaliar Inscrições de Cursos FCI</a>
           <br>
           <br>
